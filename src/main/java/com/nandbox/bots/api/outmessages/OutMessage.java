...
public abstract class OutMessage {
	...
	public enum OutMessageMethod {
		...
		,getCollectionProduct, listCollections, getProductItem,runCustomCode, extensionSetDoc, extensionDeleteDoc, extensionGetDoc, extensionListDoc,paymentConfirmation
